...
#pragma GCC diagnostic pop
        ...
        std::unique_ptr<boost::interprocess::message_queue> work_items_mq(
            new boost::interprocess::message_queue(
                boost::interprocess::create_only, "flesnet_work_items", 1000,
        ...
        std::unique_ptr<boost::interprocess::message_queue> completions_mq(
            new boost::interprocess::message_queue(
                boost::interprocess::create_only, "flesnet_completions", 1000,
    ...
    virtual void on_connect_request(struct rdma_cm_event* event) override
    {
        ...
        InputNodeInfo remote_info = *reinterpret_cast<const InputNodeInfo*>(
        ...
        try
        {
            while (true) {
                ...
                if (par->processor_executable().empty()) {
                    ...
                    _completions_mq->receive(&c, sizeof(c), recvd_size,
                                             priority);
                    if (recvd_size == 0)
                        return;
