...
void Parameters::parse_options(int argc, char* argv[]) {
  ...
  desc_add("pubHwMark", po::value<uint32_t>(&publish_hwmark_),
           "HW mark for the publisher, in TS, TS drop happens if more buffered"
           "(default: 1)");
  ...
  desc_add("subHwMark", po::value<uint32_t>(&subscribe_hwmark_),
           "HW mark for the subscriber, in TS, TS drop happens if more buffered"
           "(default: 1)");
