...
int main()
{
  ...
  std::cout << "enabled flib links detected: " << flib_links.size() << std::endl;
  ...
  for (auto link : flib_links) {
    ...
    std::cout
      ...
      << std::setw(16) << "pcs_startup_"     << index  
      << std::setw(16) << "ebtb_code_err_"   << index
      << std::setw(16) << "ebtb_disp_err_"   << index
      << std::setw(16) << "crc_error_"       << index
      << std::setw(16) << "packet_"          << index
      << std::setw(16) << "packet_err_"      << index
  ...
  // main loop
    while (true) {
      ...
      std::cout
        << std::setw(14) << std::chrono::duration_cast<std::chrono::milliseconds>(time.time_since_epoch()).count() << " ";
      for (auto link : flib_links) {
        ...
        std::cout
          << std::setw(16) << mc_index
          << std::setw(17) << pcs_startup    
          << std::setw(17) << ebtb_code_err
          << std::setw(17) << ebtb_disp_err
          << std::setw(17) << crc_error
          << std::setw(17) << packet
          << std::setw(17) << packet_err
          << std::setw(17) << loss;
      }
      std::cout << std::endl;  
      sleep(1);
