...
int main(int argc, char *argv[])
{
  ...
  printf("dlm: %01x\n", MyFlib->m_link[0]->recv_dlm());
  MyFlib->m_link[0]->prepare_dlm(0x5, true);
  MyFlib->m_link[0]->send_dlm();
  printf("dlm: %01x\n", MyFlib->m_link[0]->recv_dlm());
  printf("dlm: %01x\n", MyFlib->m_link[0]->recv_dlm());
  MyFlib->m_link[0]->prepare_dlm(0x2, false);

  printf("mc_index: %01lx\n", MyFlib->m_link[0]->get_mc_index());
  MyFlib->m_link[0]->set_start_idx(5);
