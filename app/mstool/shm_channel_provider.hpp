...
namespace
{
inline void* shm_alloc(managed_shared_memory* shm, size_t size_exp,
                       size_t item_size)
{
...
class shm_channel_provider : public DualRingBufferWriteInterface<T_DESC, T_DATA>
{

public:
    shm_channel_provider(managed_shared_memory* shm, shm_device* shm_dev,
                         size_t index, size_t data_buffer_size_exp,
