...
FlibShmChannel::FlibShmChannel(shm_channel_client* channel) : _channel(channel)
{
    ...
    uint8_t* data_buffer = reinterpret_cast<uint8_t*>(_channel->data_buffer());
    fles::MicrosliceDescriptor* desc_buffer =
        reinterpret_cast<fles::MicrosliceDescriptor*>(_channel->desc_buffer());
