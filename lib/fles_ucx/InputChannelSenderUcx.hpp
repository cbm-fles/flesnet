...
class InputChannelSenderUcx
    : public IBConnectionGroupUcx<InputChannelConnectionUcx> {
public:
  /// The InputChannelSender default constructor.
  InputChannelSenderUcx(uint64_t input_index,
  ...
  InputChannelSenderUcx(const InputChannelSenderUcx&) = delete;
  void operator=(const InputChannelSenderUcx&) = delete;

  /// The InputChannelSender default destructor.
  ~InputChannelSenderUcx() override;
