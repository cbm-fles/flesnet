...
//! The MicrosliceArchiveDescriptor precedes a stream of serialized
// StorableMicroslice objects.
class MicrosliceArchiveDescriptor
{
public:
    MicrosliceArchiveDescriptor(bool auto_initialize = false)
